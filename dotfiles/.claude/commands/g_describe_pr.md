...
1. **Read the PR description template:**
   - First, check if `thoughts/shared/pr_description.md` exists (if present)
   - check also `~/.claude/pr_description.md` exists (if thoughts/shared/pr_description.md doesn't exist)
...
8. **Save and sync the description:**
   - If the thoughts directory doesn't exist, create it with `mkdir -p thoughts/shared/prs/`
