...
- `thoughts/shared/...` → `https://github.com/[org]/thoughts/blob/main/repos/[repo]/shared/...`
- `thoughts/[user]/...` → `https://github.com/[org]/thoughts/blob/main/repos/[repo]/[user]/...`
- `thoughts/global/...` → `https://github.com/[org]/thoughts/blob/main/global/...`
...
- **[component]**: For tickets about specific component directories
- **[component]**: For tickets about specific components
- **meta**: For tickets about `hlyr` commands, thoughts tool, or `thoughts/` directory

Note: Some labels may be mutually exclusive. Check your project's label conventions.
...
1. **Locate and read the thoughts document:**
   ...
   - If given a topic/keyword, search thoughts/ directory using Grep to find relevant documents (if present)
...
4. **Comment structure example:**
   ...
   Files updated:
   - `path/to/handler.go` ([GitHub](link))
